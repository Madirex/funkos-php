...
<div class="container">
    ...
    <dl class="row">
        ...
        <dd class="col-sm-10"><?php echo htmlspecialchars($funko->stock, ENT_QUOTES, 'UTF-8'); ?></dd>
        <dt class="col-sm-2">Categoría:</dt>
        <dd class="col-sm-10"><?php echo htmlspecialchars($funko->categoryName, ENT_QUOTES, 'UTF-8'); ?></dd>
    </dl>
